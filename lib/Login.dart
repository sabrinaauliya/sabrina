...
import 'package:slicing_app/register.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            children: [
              const Text('Login Now', style: TextStyle(fontFamily: 'Ibarra', fontSize: 40, color: Color(0xFF1A5D1A), fontWeight: FontWeight.bold),),
              ...
              const SizedBox(height: 20),
              const Text('Or login with', style: TextStyle(color: Color(0xFF7D7763), fontFamily: 'Ibarra', fontSize: 16),),
              const SizedBox(height: 20),
              Row(
              ...
              const Text('Don\'t Have an Account?',
                style: TextStyle(fontFamily: 'Ibarra', fontWeight: FontWeight.w700, fontSize: 16)),
              const SizedBox(height: 20),
              ElevatedButton(
                style: ElevatedButton.styleFrom(
